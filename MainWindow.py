...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pbAdd = QtWidgets.QPushButton(self.groupBox)
        self.pbAdd.setGeometry(QtCore.QRect(430, 270, 71, 21))
        self.pbAdd.setObjectName("pbAdd")
        self.pbRemove = QtWidgets.QPushButton(self.groupBox)
        self.pbRemove.setGeometry(QtCore.QRect(510, 270, 71, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pbRemove.setText(_translate("MainWindow", "Remove"))
